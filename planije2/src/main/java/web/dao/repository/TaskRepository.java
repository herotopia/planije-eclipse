...
public interface TaskRepository {
    ...
    void updateTask(int taskId, String title, String Description, Date startDate, Date endDate, String state, String category);
     ...
     */
    Collection<Task> getPersonalTasks(User user);
